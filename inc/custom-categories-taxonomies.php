...
function cptui_register_my_taxes_bs_recipie_category() {
	...
	register_taxonomy( "bs_recipie_category", [ "bs_recipe" ], $args );
}
add_action( 'init', 'cptui_register_my_taxes_bs_recipie_category' );
